const iconProps = { width: 24, height: 24, viewBox: "0 0 24 24", fill: "currentColor", "aria-hidden": true };
...
const links = [
  ...
  { href: "https://linkedin.com", label: "LinkedIn", icon: icons.linkedin },
  { href: "https://instagram.com", label: "Instagram", icon: icons.instagram },
];

export default function SocialIcons({ className = "", linkClassName = "" }) {
  return (
